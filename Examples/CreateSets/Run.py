...
epoch_settings = {'epoch mode': 'same population', 'max repeat': 1}
...
from RunMinimisation import Minimisation_Function # lgtm [py/unused-import]
...
#predation_information = {'Predation Operator': 'DCM', 'percentage_diff': 5.0}
...
''' ---------------- '''
# This will execute the genetic algorithm program. This has been commented out because we dont want GA_Program to run, we only want to get the variables from the Run.py file. 
