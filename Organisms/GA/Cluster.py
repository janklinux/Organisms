...
class Cluster(Atoms):
    """
    This class is designed to include all the information for the genetic algorithm from the chemical system.

    :param symbols: This can be a list of all the chemical symbols of atoms in the clusters, OR, the ASE.Atoms object
    that this object will be base on. For writing this as a list of element symbols, see
    https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  symbols: str (formula) or list of str., or ASE.Atoms
    :param positions: A list of all the (x,y,z) values for the cluster.
    See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  positions: list of xyz-positions
    :param numbers: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  numbers: list of int
    :param tags: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  tags: list of int
    :param momenta: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  momenta: list of xyz-momenta
    :param masses: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  masses: list of float
    :param magmoms: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  magmoms: list of float or list of xyz-values
    :param charges: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  charges: list of float
    :param scaled_positions: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms
    for more information.
    :type  scaled_positions: list of scaled-positions
    :param cell: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  cell: 3x3 matrix or length 3 or 6 vector
    :param pbc: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  pbc: one or three bool
    :param celldisp: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  celldisp: Vector
    :param constraint: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  constraint: constraint object(s)
    :param calculator: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  calculator: calculator object
    :param info: See https://wiki.fysik.dtu.dk/ase/ase/atoms.html?highlight=atoms#ase.Atoms for more information.
    :type  info: dict of key-value pairs
    :param surface: This is the surface that the cluster is modelled on. This is given either as a string or
    the ASE.Atoms object. Default: None
    ...
    def verify_cluster(self, name, gen_made, vacuum_length, rounding_criteria):
        """
        This method will verify that the cluster contains all the other information that it needs to
        run during the genetic algorithm, providing the name, generation made, and the energy of the cluster,
        as well as centering in a unit cell.
        This method is performed after the cluster has been locally optimised.

        :param name: The name that the cluster is referenced in this genetic algorithm program. This should be a
        integer that is based on when the cluster was made.
        :type  name: int/str.
    ...
    def custom_verify_cluster(self, name, gen_made, cluster_energy, ever_in_population,
                              excluded_because_violates_predation_operator, initial_population):
        """
        This method allows you to custom verify the cluster. To be used when resuming the genetic algorithm.

        :param name: The name that the cluster is referenced in this genetic algorithm program.
        This should be a integer that is based on when the cluster was made.
        :type  name: int/str.
        :param gen_made: This is the generation when the cluster was created
        :type  gen_made: int
        :param ever_in_population: Was this cluster ever in the population.
        :type  ever_in_population: bool.
        :param excluded_because_violates_predation_operator: Was the cluster removed from the offspring pool
        because it violated the predation operator
        :type  excluded_because_violates_predation_operator: bool.
        :param initial_population: Was the cluster apart of the initial population, either at rhe beginning
        of the population or after an epoch.
    ...
    def sortZ(self):
        """
        Sort the cluster from most positive to most negative value of z. This sorting by z axis is
        required to allow the algorithm to easily split itself into two sides of a dividing plane.
    ...
    def get_total_cluster_energy(self, rounding_criteria=None):
        ...
        for el in self.get_chemical_symbols():
            if el not in elements:
                elements[el] = self.get_chemical_symbols().count(el)

        chem_pot = 0
        for el in elements:
            isolated = Atoms(symbols=el, positions=[[0, 0, 0]], cell=[[10, 0, 0], [0, 10, 0], [0, 0, 10]])
            isolated.set_calculator(self.get_calculator())
            chem_pot += elements[el] * isolated.get_potential_energy()

        energy = (self.get_potential_energy() - chem_pot) / self.get_global_number_of_atoms()
        if rounding_criteria is not None:
    ...
    def centre_cluster_at_centre_of_cell(self, vacuumAdd):
        """
        This method will center the cluster in the middle of the cell. This method has been employed to
         make it easier to look at clusters that are made during the Organisms program.
        ...
        self.sortZ()
        self.center()
        # self.center(vacuum=None, axis=(0, 1, 2), about=0.5)  # make a better center function?
    ...
    def deepcopy(self):
        """
        Will create a copy of the Cluster. This copy does not include a copy of the calculator as
        this has the potential to cause issues.
        """
        # return self.copy()
    ...
    def deepcopy_skeleton(self):
        """
        This will create a copy of the cluster that does not contain any atoms, but will contain all the other
