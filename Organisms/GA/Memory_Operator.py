...
from Organisms.GA.SCM_Scripts.T_SCM_Methods import get_CNA_similarity     as get_CNA_similarity_T_SCM
from Organisms.GA.SCM_Scripts.A_SCM_Methods import get_CNA_similarity     as get_CNA_similarity_A_SCM
