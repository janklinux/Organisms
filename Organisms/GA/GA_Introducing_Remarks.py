...
def GA_Program_Logo():
	...
	print("|                  `V-'`'\\/``                                  ('>         |")
	print("|                                                              /))"+colored("@@@@@.",'green')+"   |")
	print('|         .----------------------------------.                /'+colored('@','green')+'"'+colored('@@@@@()@','green')+'  |')
	print("|         | Welcome to the Organisms program |               "+colored(".@@()@@()@@@@",'green')+" |")
	print("|         '----------------------------------'               "+colored("@@@O@@@@()@@@",'green')+" |")
	print("|                  ^                                         "+colored("@()@@\\@@@()@@",'green')+" |")
	print("|  _     (\\_/)     |                                          "+colored("@()@",'green')+'||'+colored("@@@@@'",'green')+" |")
	print("| ( \\    (0.o) ----'                 _                         "+colored("'@@",'green')+'||'+colored("@@@'",'green')+"   |")
	print("|  ) )   (> <)                     _(_)_            wWWWw   _     ||       |")
	print("| ( (  .-'''''-.  A.-.A      @@@@ (_)@(_)       _   (___) _(_)_   ||       |")
	print("|  \\ \\/         \\/ , , \\    @@()@@  (_)\\      _(_)_   Y  (_)@(_)  ||       |")
	print("|   \\   \\        ;= t =/     @@@@      `|/   (_)@(_) \\|/   (_)\\   ||       |")
